        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <h3 class="=pt-2"> بدر جعفر</h3>
                    <a ><h5><span class="badge rounded-pill bg-info ">إقتصاد وأعمال</span></h5></a>
                    </div>
                <div class="row">
                <div class="col-sm-12 py-2">الرئيس التنفيذي ل" مجموعة الهلال" ورئيس" شركة نفط الهلال "</div>
                <div class="col-sm-2 py-2">الولادة:</div>
                <div class="col-sm-10 py-2">9 أغسطس 1979 العمر 42 سنة</div>
                <div class="col-sm-2 py-2">الجنسية</div>
                <div class="col-sm-10 py-2">الإمارات</div>
                <div class="col-sm-11  text-muted py-2">الإمارات العربية المتحدة</div>
                <dt class="col-sm-12 py-2">
                    <a class="btn btn-primary w-25 mx-2">متابعة</a>
                    <a class="btn btn-outline-primary w-40 mx-2">هل أنته بدر جعفر؟</a>
                </dt>
                </div>
                </div>
            </div>
